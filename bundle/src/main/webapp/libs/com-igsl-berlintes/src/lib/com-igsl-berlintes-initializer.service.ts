...
@Injectable()
export class ComIgslBerlintesInitializer implements IRxApplicationInitializer {
  ...
  initialize(): void {
    ...
    const assetFolderPath = this.getAssetPathService.getAssetRootPath('com.igsl.berlintes');
