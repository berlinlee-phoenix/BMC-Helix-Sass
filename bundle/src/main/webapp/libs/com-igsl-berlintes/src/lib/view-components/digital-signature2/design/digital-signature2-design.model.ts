...
import { IDigitalSignature2Parameters } from './digital-signature2.interface';

// View component input parameters.
const initialComponentProperties: IDigitalSignature2Parameters = {
  styles: '',
  hidden: '',
  message: ''
};

export class DigitalSignature2DesignModel extends ViewDesignerComponentModel implements IViewDesignerComponentModel {
  constructor(protected injector: Injector,
    ...
    combineLatest([this.sandbox.componentProperties$])
      .pipe(
        map(([componentProperties]: [IDigitalSignature2Parameters]) =>
  ...
  static getInitialProperties(initialProperties?: IDigitalSignature2Parameters): IDigitalSignature2Parameters {
  ...
  private setInspectorConfig(model : IDigitalSignature2Parameters) {
    return {
  ...
  private validate(
    ...
    model: IDigitalSignature2Parameters
