...
import { IIgsIconParameters } from './igs-icon.interface';

// View component input parameters.
const initialComponentProperties: IIgsIconParameters = {
  styles: '',
  hidden: '',
  message: ''
};

export class IgsIconDesignModel extends ViewDesignerComponentModel implements IViewDesignerComponentModel {
  constructor(protected injector: Injector,
    ...
    combineLatest([this.sandbox.componentProperties$])
      .pipe(
        map(([componentProperties]: [IIgsIconParameters]) =>
  ...
  static getInitialProperties(initialProperties?: IIgsIconParameters): IIgsIconParameters {
  ...
  private setInspectorConfig(model : IIgsIconParameters) {
    return {
